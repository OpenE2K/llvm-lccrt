...
set_target_properties(LLVMSupport PROPERTIES
  INTERFACE_LINK_LIBRARIES "z;rt;dl;curses;-lpthread;m;LLVMDemangle"
)
...
set_target_properties(LLVMCodeGen PROPERTIES
  INTERFACE_LINK_LIBRARIES "-lpthread;LLVMAnalysis;LLVMBitReader;LLVMBitWriter;LLVMCore;LLVMLccrt;LLVMMC;LLVMProfileData;LLVMScalarOpts;LLVMSupport;LLVMTarget;LLVMTransformUtils"
)
...
# Create imported target LLVMLccrt
add_library(LLVMLccrt STATIC IMPORTED)

set_target_properties(LLVMLccrt PROPERTIES
  INTERFACE_LINK_LIBRARIES "-llccrt;LLVMAnalysis;LLVMCore;LLVMMC;LLVMMCParser;LLVMSupport;LLVMTarget;LLVMTransformUtils;/usr/lib/liblccrt.so"
)
...
# Create imported target LLVMElbrusCodeGen
add_library(LLVMElbrusCodeGen STATIC IMPORTED)

set_target_properties(LLVMElbrusCodeGen PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMAnalysis;LLVMAsmPrinter;LLVMCodeGen;LLVMCore;LLVMElbrusInfo;LLVMMC;LLVMScalarOpts;LLVMSelectionDAG;LLVMSupport;LLVMTarget;LLVMTransformUtils"
)

# Create imported target LLVMElbrusInfo
add_library(LLVMElbrusInfo STATIC IMPORTED)

set_target_properties(LLVMElbrusInfo PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMSupport"
)
